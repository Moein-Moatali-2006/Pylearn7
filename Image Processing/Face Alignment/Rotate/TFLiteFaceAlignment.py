...
if __name__ == '__main__':
    ...
    fd = UltraLightFaceDetecion(
        "C:\Sajjad_Aemmi\PR_git\Pylearn7\Image Processing\Face Alignment\Models\RFB-320.tflite",
        conf_threshold=0.88)
    fa = CoordinateAlignmentModel(
        "C:\Sajjad_Aemmi\PR_git\Pylearn7\Image Processing\Face Alignment\Models\coor_2d106.tflite")
    ...
    while True:
        ...
        for pred in fa.get_landmarks(frame, boxes):
            for p in np.round(pred).astype(np.int_):

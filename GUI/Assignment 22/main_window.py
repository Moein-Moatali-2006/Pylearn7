...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.tb_new_task_title.sizePolicy().hasHeightForWidth())
        self.tb_new_task_title.setSizePolicy(sizePolicy)
        ...
        sizePolicy2.setHeightForWidth(self.tb_new_task_description.sizePolicy().hasHeightForWidth())
        self.tb_new_task_description.setSizePolicy(sizePolicy2)
